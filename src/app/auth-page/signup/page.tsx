  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      if (file.size > maxSize) {
        setErrors("Image file is too large. Please choose a file smaller than 5MB.");
        return;
      }
    ...
    try {
      ...
      if (imageFile) {
        try {
          ...
          setErrors("Failed to process image. Please try a different image.");
          setIsLoading(false);
          isSubmitting = false;
          return;
        }
      ...
      const newUser = {
        ...user,
        photo: base64Image || "/images/user/user-01.png",
      };
                ...
                <div className="mb-4">
                  ...
                  <div className="relative flex items-center justify-center">
                    ...
                    <div
                      ...
                      className="flex cursor-pointer flex-col items-center border-2 border-dashed border-gray-300 rounded-lg p-6 hover:border-primary transition-colors"
                    >
                      {imageFile ? (
                        <div className="text-center">
                          <div className="text-green-600 mb-2">✓ Image Selected</div>
