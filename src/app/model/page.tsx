...
const ModalLayout = () => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      // Use our backend API route instead of calling NVIDIA directly
      ...
      if (!data.molecules) {
        throw new Error("No molecules data in response");
      }
      ...
      alert(`❌ Error generating molecules: ${error instanceof Error ? error.message : 'Unknown error'}`);
    } finally {
      setLoading(false);
    }
  };
